...
<div>
  ...
  <ul class="nav nav-tabs">
    <li role="presentation" class="nav-item"><a href="#data" class="nav-link" aria-controls="home" role="tab" data-toggle="tab">Persönliche Daten</a></li>
	<li role="presentation" class="nav-item"><a href="#email" class="nav-link" aria-controls="profile" role="tab" data-toggle="tab">E-Mail</a></li>
	<li role="presentation" class="nav-item"><a href="#passwort" class="nav-link" aria-controls="profile" role="tab" data-toggle="tab">Passwort</a></li>
  </ul>
